...
test = Test.new("PUBVV-sMYgCVmTBI31iwEw9Qz8_XvyQk", "PRIpOYUeeFF3sV%KGsSSxCINDLBpmXoH", "consumer-key", "consumer-secret", "http://mashape.com/validate");

#test.authenticate_oauth("access-token", "access-secret");
